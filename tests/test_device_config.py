...
from custom_components.tuya_selfhost.helpers.config import get_device_id
from custom_components.tuya_selfhost.helpers.device_config import (
    TuyaDeviceConfig,
    TuyaDpsConfig,
    TuyaEntityConfig,
    _bytes_to_fmt,
...
from custom_components.tuya_selfhost.sensor import TuyaLocalSensor
...
def check_entity(entity, cfg, mocker):
    ...
    """
    fname = f"custom_components/tuya_selfhost/devices/{cfg}"
